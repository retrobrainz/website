...
export default class extends BaseSeeder {
  ...
  async run() {
    ...
    for (const props of [
      ...
      },
      {
        ...
        photoUrl:
          'https://upload.wikimedia.org/wikipedia/commons/thumb/f/f4/Nintendo-Famicom-Disk-System.png/1280px-Nintendo-Famicom-Disk-System.png',
      },
      {
        name: 'Game Boy',
        screenWidth: 160,
        ...
        photoUrl:
          'https://upload.wikimedia.org/wikipedia/commons/thumb/7/7c/Game-Boy-FL.png/1280px-Game-Boy-FL.png',
      },
      {
      ...
      },
      {
        ...
        photoUrl:
          'https://upload.wikimedia.org/wikipedia/commons/thumb/3/35/Nintendo-Game-Boy-Color-FL.png/1280px-Nintendo-Game-Boy-Color-FL.png',
      },
      {
        ...
        photoUrl:
          'https://upload.wikimedia.org/wikipedia/commons/thumb/0/0b/Nintendo-Game-Boy-Advance-Purple-FL.png/1280px-Nintendo-Game-Boy-Advance-Purple-FL.png',
      },
      {
        name: 'GameCube',
        screenWidth: 640,
      ...
      },
      {
        ...
        photoUrl:
          'https://upload.wikimedia.org/wikipedia/commons/thumb/5/56/Nintendo-DS-Lite-Black-Open.png/1280px-Nintendo-DS-Lite-Black-Open.png',
      },
      {
        name: 'Wii',
        screenWidth: 640,
      ...
      },
      {
        ...
        photoUrl:
          'https://upload.wikimedia.org/wikipedia/commons/thumb/8/89/Nintendo-DSi-Bl-Open.png/1280px-Nintendo-DSi-Bl-Open.png',
      },
      {
        name: 'Nintendo 3DS',
        screenWidth: 400,
        ...
        photoUrl:
          'https://upload.wikimedia.org/wikipedia/commons/thumb/0/0a/Nintendo-3DS-AquaOpen.png/1280px-Nintendo-3DS-AquaOpen.png',
      },
      {
        name: 'Wii U',
        screenWidth: 1280,
      ...
      },
      {
        ...
        photoUrl:
          'https://upload.wikimedia.org/wikipedia/commons/thumb/b/bc/Nintendo-Switch-wJoyCons-BlRd-Standing-FL.png/1280px-Nintendo-Switch-wJoyCons-BlRd-Standing-FL.png',
      },
    ]) {
    ...
    for (const props of [
      ...
      },
      {
        ...
        photoUrl:
          'https://upload.wikimedia.org/wikipedia/commons/thumb/2/2e/Sony-PlayStation-2-30001-wController-L.png/1280px-Sony-PlayStation-2-30001-wController-L.png',
      },
      {
        ...
        photoUrl:
          'https://upload.wikimedia.org/wikipedia/commons/thumb/9/9a/PSP-1000.png/1280px-PSP-1000.png',
      },
      {
        name: 'PlayStation 3',
        screenWidth: 1280,
        ...
        photoUrl:
          'https://upload.wikimedia.org/wikipedia/commons/thumb/6/6d/Sony-PlayStation-3-4001B-wController-noBG.png/1280px-Sony-PlayStation-3-4001B-wController-noBG.png',
      },
      {
        ...
        photoUrl:
          'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e0/PlayStation-Vita-1101-FL.png/1280px-PlayStation-Vita-1101-FL.png',
      },
      {
        name: 'PlayStation 4',
        screenWidth: 1920,
    ...
    for (const props of [
      ...
      },
      {
        ...
        photoUrl:
          'https://upload.wikimedia.org/wikipedia/commons/thumb/2/2e/Sega-Genesis-Mk2-6button.png/1280px-Sega-Genesis-Mk2-6button.png',
      },
      {
        name: 'Game Gear',
        screenWidth: 160,
      ...
      },
      {
        ...
        photoUrl:
          'https://upload.wikimedia.org/wikipedia/commons/thumb/d/d1/Sega-CD-Model2-Set.png/1280px-Sega-CD-Model2-Set.png',
      },
      {
        name: '32X',
        screenWidth: 320,
        ...
        photoUrl:
          'https://upload.wikimedia.org/wikipedia/commons/thumb/8/8c/Sega-Genesis-Model2-32X.png/1280px-Sega-Genesis-Model2-32X.png',
      },
      {
        name: 'Saturn',
        screenWidth: 320,
      ...
      },
      {
        ...
        photoUrl:
          'https://upload.wikimedia.org/wikipedia/commons/thumb/0/07/Dreamcast-Console-Set.png/1280px-Dreamcast-Console-Set.png',
      },
    ]) {
  ...
  async createPlatform({ companyId, name, logoUrl, photoUrl, ...rest }: any) {
    ...
    if (!platform.logoId && logoUrl) {
      const logo = await Image.fromHttp(logoUrl, {
        width: 512,
        height: 512,
        format: 'avif',
        fit: 'inside',
      ...
      await sleep(1000); // To avoid hitting request limits
    }

    if (!platform.photoId && photoUrl) {
      const photo = await Image.fromHttp(photoUrl, {
        width: 1280,
        height: 720,
        format: 'avif',
        fit: 'contain',
